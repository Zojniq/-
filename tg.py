...
from modules.schedule import SCHEDULE, WEEKDAY_TO_INDEX, get_lessons_for_day
from modules.homework import HOMEWORK, load_homework, save_homework

# === СЮДИ ВСТАВ СВІЙ ТОКЕН БОТА ===
BOT_TOKEN = os.getenv("BOT_TOKEN")  # Токен бота з env
...
REMINDER_INTERVAL = 15  # Інтервал нагадувань за замовчуванням (хвилини)
...
async def remind_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """
    /remind <minutes>:
    - Змінює інтервал нагадувань перед парами.
    """
...
def schedule_jobs_for_chat(application: Application, chat_id: int) -> None:
    ...
    Використовує змінний інтервал REMINDER_INTERVAL.
    """
    ...
    for i, lesson in enumerate(SCHEDULE):
        ...
        # Час нагадування: T = час пари - REMINDER_INTERVAL хвилин
...
async def save_homework_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """
    Зберігає ДЗ для вибраного предмета та оновлює JSON-файл.
    """
    ...
    save_homework()  # Зберігаємо в JSON-файл
...
async def list_homework(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    """
    load_homework()  # Завантажуємо з JSON-файлу
    if not HOMEWORK:
...
async def today_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Відображає розклад на сьогодні."""
...
async def week_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    """Відображає розклад на весь тиждень."""
...
def main() -> None:
    ...
    load_homework()  # Завантаження ДЗ при старті
